...
This proposal is required to adopt version 1.6.7 which introduces fixes and improvements to the Cosmos Millions protocol.

Full PR here https://github.com/lum-network/chain/pull/77
## How to upgrade

- This upgrade is scheduled for `Thursday, May 16th around 15:00 UTC.`
- The exact target block is `13241000`
- Upon reaching this block you will see a message `ERR UPGRADE "v1.6.7" NEEDED at height: 13241000` and `ERR CONSENSUS FAILURE!!!`
