...
This pull request introduces the new DFR (DFract) module beta implementation.
The DFR module aims to be isolated from the core network implementation and should not have any critical impact on the existing capabilities of the network. 

Its goal is to introduce a beta implementation of a protocol owned liquidity on the Lum Network.

Key added items:

- Register new module DFract
- New message type
- New governance proposal type

## How to upgrade

- This upgrade is scheduled for Thursday `Sep. 23 around 16:30 UTC`
- The exact target block is `4066500`
- Upon reaching this block you will see a message `ERR UPGRADE "v1.2.1" NEEDED at height: 4066500` and `ERR CONSENSUS FAILURE!!!`
