...
- CosmosMillions: Unlock deposit entities upon ICA channel restoration. Ensure all entities are correctly persisted
- CosmosMillions: Revamp the fee system to allow for multiple fee takers (Millions revenue sharing model)

Full PR here https://github.com/lum-network/chain/pull/68

## How to upgrade

- This upgrade is scheduled for Wednesday `Thursday, february 1st around 16:15 UTC`
- The exact target block is `11390000`
- Upon reaching this block you will see a message `ERR UPGRADE "v1.6.4" NEEDED at height: 11390000` and `ERR CONSENSUS FAILURE!!!`
...
- Once you receive this message you must upgrade you node:
  ...
  - `lumd version`
    - `1.6.4`
    - `808aad2ee95e4e43ed117de1e2c85acb6e0d9e10`
