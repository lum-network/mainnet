...
- Refactoring of Pool lifecycle abstraction.
- Improvements of Batch withdrawals with respect to remote zone unbonding frequency
- Manual seed generation consensus-based
- Fix ICQ edge case issues

## How to upgrade

- This upgrade is scheduled for Wednesday `Friday, September 29th around 14:25 UTC`
- The exact target block is `9520750`
- Upon reaching this block you will see a message `ERR UPGRADE "v1.6.1" NEEDED at height: 9520750` and `ERR CONSENSUS FAILURE!!!`
...
- Once you receive this message you must upgrade you node:
  ...
  - `lumd version`
    - `1.6.1`
    - `0f96fc6f589165fc1fd02614e2c6211a0b6973eb`
