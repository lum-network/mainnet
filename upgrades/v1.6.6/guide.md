...
This proposal is required to adopt version 1.6.6 which introduces a vulnerability patch alongside an upgrade to unblock the Cosmos Millions HUAHUA Pool from its stalling state.

Full PR here https://github.com/lum-network/chain/pull/76
## How to upgrade

- This upgrade is scheduled for `Thursday, May 16th around 15:00 UTC.`
- The exact target block is `12969000`
- Upon reaching this block you will see a message `ERR UPGRADE "v1.6.6" NEEDED at height: 12969000` and `ERR CONSENSUS FAILURE!!!`
...
- Once you receive this message you must upgrade you node:
  ...
  - `lumd version`
    - `1.6.6`
    - `8262e82bc033f658d58308a55981376896d5e268`
