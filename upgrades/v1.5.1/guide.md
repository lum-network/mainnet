...
This proposal fixes an issue introduced in the previous update and update Millions prize strategy.

- ICA logic improvement & fix
- ATOM Pool prize strategy update
  - Make all the prizes a 'unique' win to prevent the winner (in case a winner is found) to also win other prizes
...
- Once you receive this message you must upgrade you node:
  ...
  - `lumd version`
    - `1.5.1`
    - `bf17d9b72aed8a007a2d47f1324faa948a843a91`
