...
- Add the Epoch module
- Introduces Millions batched withdrawals feature
- Bump to Cosmos SDK v0.47.4

## How to upgrade

- This upgrade is scheduled for Wednesday `Friday, August 4st around 18:00 UTC.`
- The exact target block is `8688700`
- Upon reaching this block you will see a message `ERR UPGRADE "v1.5.2" NEEDED at height: 8688700` and `ERR CONSENSUS FAILURE!!!`
...
- Once you receive this message you must upgrade you node:
  ...
  - `lumd version`
    - `1.5.2`
    - `0b46b1607c4357f5d590831049eecc011e21da37`
